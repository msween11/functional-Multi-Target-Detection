...
parfor si = 1:numSeeds
    ...
    %l8 space errs
    l8_kot_space_err = zeros(1,length(lrange));
    l8_fm_space_err = zeros(1,length(lrange));
    l8_spec_space_err = zeros(1,length(lrange));

    %l2 space errs
    l2_kot_space_err = zeros(1,length(lrange));
    l2_fm_space_err = zeros(1,length(lrange));
    l2_spec_space_err = zeros(1,length(lrange));

    %l8 freq errs
    l8_kot_freq_err = zeros(1,length(lrange));
    l8_fm_freq_err = zeros(1,length(lrange));
    l8_spec_freq_err = zeros(1,length(lrange));

    %l2 freq errs
    l2_kot_freq_err = zeros(1,length(lrange));
    l2_fm_freq_err = zeros(1,length(lrange));
    l2_spec_freq_err = zeros(1,length(lrange));
    ...
    [params, grids] = setparams(n = 2^10, l = lrange(idx), B = 10, z = 1, ...
